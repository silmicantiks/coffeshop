...
public class mainFormController implements Initializable {
    ...
    public void menuReceiptBtn() {
        ...
        if (totalP == 0 || menu_amount.getText().isEmpty()) {
            ...
            try {
                // Menggunakan ClassLoader untuk mendapatkan direktori kerja saat ini
          // Mendapatkan direktori kerja saat ini
            String currentDir = System.getProperty("user.dir");
            
            // Membentuk path relatif ke file di dalam folder cafeshopmanagementsystem
            String reportPath = currentDir + "/src/cafeshopmanagementsystem/report.jrxml";
